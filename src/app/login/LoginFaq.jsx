    ...
    <div className='login-Faqs lg:px-44 md:px-32 px-4 py-10 flex flex-col items-center'>
        ...
        <div className="Faqs flex flex-col gap-4">
                 ...
                 <p className='text-lg mb-3'>Income Tax Return (ITR) efiling is the process of electronically submitting your income tax return to the tax authorities 
                  ...
                  their tax obligations and completing the income tax login process.In traditional income tax filing methods, taxpayers would manually fill
                   out paper tax forms and submit them physically to the tax department. However, with ITR efiling process, taxpayers can complete their tax returns online
                    using tax software (like File Your Tax) or government-authorized income tax e-filing site login.</p>
          ...
          <div className="login-faq py-3">
            ...
            <p className='text-lg mb-3'>Income tax return can be filed via income tax login at the income tax department’s <span className='blue-text'>website</span> or you can simply visit File Your Tax
               income tax login page. At File Your Tax you can file the ITR in just 5 steps here. File Your Tax offers two ways to file the ITR: <span className='blue-text'>DIY
          ...
          <div className="login-faq py-3">
            <div className="que font-bold text-xl mb-3">What is the advantage of ITR filing via File Your Tax portal? </div>
            <p className='text-lg mb-3'>File Your Tax is authorized by the income tax department; hence, the ITR filed will be considered valid. Its easy-to-use interface allows
               ...
               File Your Tax motive is to simplify the complex process of tax filing so that a person with zero knowledge of taxes can also file their taxes easily.</p>
          </div>


          <div className="login-faq py-3">
            <div className="que font-bold text-xl mb-3">Can I file ITR online with File Your Tax even if I am not registered on the income tax efiling portal?</div>
            <p className='text-lg mb-3'>It is necessary for you to first get registered on the income tax e-filing portal to file your ITR with File Your Tax. File Your Tax website computes the 
              taxation basis on the sources of income and other details provided by you. File Your Tax, offers the feature of pre-filling data from the income tax
          ...
          <div className="login-faq py-3">
            ...
            <p className='text-lg mb-3'>Yes, at File Your Tax you can file the ITR even without having Form 16. All you need to have salary slips, bank
...
<p className='text-lg mb-3'>Yes, at File Your Tax we provide you with the option to file your tax return on your <span className='blue-text'>own</span>. It’s Easy, quick, and free when you file with File Your Tax on your own.
   You simply login to our itr filing page and have to provide a few basic details about your income, and prefill your rest details in one click. Isn’t this easy
    and quick! File ITR with File Your Tax under 4 minutes.</p>
          ...
          <div className="login-faq py-3">
            ...
            <p className='text-lg mb-3'>File Your Tax offers the services where you can <span className='blue-text'>Book an eCA</span>. A dedicated Tax Expert who tackles your taxes from start to finish. An end-to end
               tax filing assistance is provided by the professionals, who at each step provide you with all-round support and ensure error-free filing.
                Claim exciting discounts on booking a tax expert at File Your Tax.</p>
          </div>
