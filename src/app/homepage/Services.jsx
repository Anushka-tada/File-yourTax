  ...
  return (
    <div className="section5 lg:px-24 px-4 py-20  ">
      <div className="text-center">
        ...
        <h1 className="section5-heading lg:font-bold  md:font-bold  font-semibold text-5xl mb-12"> Income Tax Services Provided by Us </h1>
      </div>
      {/* 
      ...
      <div className="section5-boxes flex flex-wrap justify-center lg:px-16   lg:gap-5 gap-2">
        <div className="flex flex-wrap justify-center lg:flex-nowrap gap-5">
          <div className="section5-box-1 first-box p-9 rounded-2xl">
            <h1 className="text-white lg:font-bold  md:font-bold  font-semibold text-4xl mb-6">Strategic Tax Planning Services</h1>
            <p className="text-white mb-8 text-xl ">Optimize your tax savings with FileyourTax Tax Advisory Services, providing expert
              guidance on advance tax calculaƟons, property transactions, and other tax-related matters.</p>
          ...
          <div className="section5-box-sameline rounded-xl p-5 bg-white">
            ...
            <p className="mb-4">A dedicated tax expert provides guidance and assistance in navigating and responding
              to notices issued under Sections 139(9), 143(1), high-value transactions, and other
              communications from the Income Tax Department.</p>
        ...
        <div className="section5-box-2 rounded-xl p-5 bg-white flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="mb-4">Engage a dedicated eCA for your Income Tax Filing, ensuring a
              seamless and efficient process with accurate calculations to maximize
              your refund.</p>
          </div>
          <div className="flex gap-2">
        ...
        <div className="section5-box-2 rounded-xl p-5 bg-white flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="mb-4">Streamline your Indian tax filing with our expert assistance,
encompassing both foreign and domestic income. Our online
Chartered Accountant ensures full compliance with Income Tax laws
and helps you claim all eligible tax deductions.</p>
          </div>
          <div className="flex gap-2">
        ...
        <div className="section5-box-2 rounded-xl p-5 bg-white flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="mb-4">Streamline the Income Tax Return filing process with File Your Tax.
Simply submit your Form 16, and your ITR will be prepared
automatically.</p>
          </div>
          <div className="flex gap-2 ">
        ...
        <div className="section5-box-2 rounded-xl p-5 bg-white flex flex-col justify-between">
          ...
          <div>
            ...
            <p className="mb-4">Obtain expert tax guidance on transactions related to the sale of property, equity
            shares, mutual fund units, or bonds, in addition to salary or business income.</p>
          </div>
          <div className="flex gap-2">
